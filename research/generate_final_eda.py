...
# Map target values to meaningful names - fix the target mapping issue
target_col = 'target'
...
# Generate column information - fix the indentation issue  
columns_info = []
for col in df.columns:
    if col == 'target':
        ...
        continue  # Skip the helper column
    ...
    elif col in numerical_features:  # numerical features
        columns_info.append({
            "name": col,
